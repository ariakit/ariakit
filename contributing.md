...
This repository uses [pnpm workspaces](https://pnpm.io/workspaces) to manage multiple ESM projects. You need to install **pnpm v10 or higher** and **Node.js v18 or higher**.
...
If the versions are not correct or you don't have Node.js installed, download it from https://nodejs.org and enable pnpm with `corepack enable`.
