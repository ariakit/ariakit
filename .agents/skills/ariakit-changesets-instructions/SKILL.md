...
- When mentioning public APIs in the description, link to the Ariakit reference docs with an HTML anchor, for example: `<a href="https://ariakit.org/reference/menu-item-radio">` + "`MenuItemRadio`" + `</a>`.
