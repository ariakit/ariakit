...
import { Container, ComposableContainer, ActionMap, ContainerProps } from "constate";
...
export type HiddenContainerProps = ContainerProps<HiddenContainerState, HiddenContainerActions>;
