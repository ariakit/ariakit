  ...
  function Command({ flat, variant, ...props }, ref) {
    return (
      <Role.button
        ...
        ref={ref}
        className={twMerge(
          "flex h-10 touch-none select-none items-center justify-center gap-1 whitespace-nowrap rounded-lg border-none bg-white px-4 text-base text-black no-underline outline-2 outline-offset-2 outline-blue-600 hover:bg-gray-100 aria-disabled:opacity-50 aria-expanded:bg-gray-100 data-[focus-visible]:outline dark:bg-white/5 dark:text-white dark:hover:bg-white/10 aria-expanded:dark:bg-white/10 sm:gap-2",
          "active:pt-0.5",
          !flat &&
          ...
          variant
            ? "[--border:rgba(0,0,0,0.15)] [--highlight:rgba(255,255,255,0.25)] [--shadow:rgba(0,0,0,0.15)] dark:[--border:rgba(255,255,255,0.2)] dark:[--highlight:rgba(255,255,255,0.07)] dark:[--shadow:rgba(0,0,0,0.25)]"
          ...
          variant === "plus" &&
            "bg-gradient-to-br from-emerald-600 to-blue-600 text-white hover:from-emerald-700 hover:to-blue-700 dark:bg-gradient-to-br dark:from-emerald-800 dark:to-blue-700 dark:hover:from-emerald-700 dark:hover:to-blue-600",
          variant === "primary" &&
