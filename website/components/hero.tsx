  ...
  return (
    <div className="flex flex-col items-center gap-8 p-5 px-3 sm:px-4 md:px-8">
      <div className="mt-4 flex w-full max-w-5xl flex-col items-center gap-8 sm:mt-10 md:mt-20">
        <h1 className="bg-gradient-to-br from-[hsl(175_100%_35%)] to-[hsl(204_100%_35%)] bg-clip-text text-center text-5xl font-extrabold tracking-[-0.035em] text-transparent dark:from-[hsl(175_100%_60%)] dark:to-[hsl(204_100%_58%)] dark:font-bold dark:tracking-[-0.015em] sm:text-6xl md:text-7xl">
