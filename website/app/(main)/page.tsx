  ...
  return (
    <>
      ...
      <div className="p-3 sm:p-8">
        <div className="sm:rounded-x mx-auto grid w-full max-w-6xl grid-cols-1 justify-between gap-4 rounded-lg p-4 sm:grid-cols-2 sm:gap-10 sm:p-10 md:gap-20 md:rounded-2xl md:p-16">
