...
const wideBody: TableRows<WideColumn> = [
  ...
  [
    ...
    "2026-09-04",
    "4.8 kB",
    "Current page links and collapsible groups",
  ],
  [
    "Table",
    "Covered",
  ...
  return (
    <Samples columns="wide">
      ...
      <Sample
        ...
        description="A selected row mixes the brand colour into its surface, on the layer channel, so the hover still steps on top of it: hover a selected row. The row takes the lines around it with the tint, as a hovered row does, so they keep their contrast against it. With a checkbox column, the head cell fits its select-all and one column takes the surplus width. Rows are selectable in a grid, so both tables take the grid role."
      >
        <div className="grid items-start gap-4 lg:grid-cols-2">
          <div className="grid gap-1">
