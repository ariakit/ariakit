...
withCaptures(import.meta.dirname, async ({ query, test }) => {
  ...
  test(
    "page @visual",
    { annotation: { type: "ariviso:item", description: "ui/progress/page" } },
    async ({ page, visual }) => {
  ...
  test(
    "keeps bars and rings visible in forced colors @visual",
    {
      annotation: {
        type: "ariviso:item",
        description:
          "ui/progress/keeps-bars-and-rings-visible-in-forced-colors",
      },
    },
    async ({ page, q, visual }) => {
  ...
  test(
    "draws the track edge only on a bordered track in high contrast @visual",
    {
      annotation: {
        type: "ariviso:item",
        description:
          "ui/progress/draws-the-track-edge-only-on-a-bordered-track-in-high-contrast",
      },
    },
    async ({ page, q, visual }) => {
  ...
  test(
    "moves the bar and the ring to a new value @visual",
    {
      annotation: {
        type: "ariviso:item",
        description: "ui/progress/moves-the-bar-and-the-ring-to-a-new-value",
      },
    },
    async ({ page, q, visual }) => {
      await forEachColorScheme(page, async (colorScheme) => {
