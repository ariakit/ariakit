  ...
  return (
    <ExampleGrid>
      <Example
        ...
        code={`
          <DialogProvider>
            <DialogDisclosure $kind="bevel">View receipt</DialogDisclosure>
            <Dialog>
        ...
        code={`
          <DialogProvider>
            ...
            <Dialog>
              ...
              <Input />
              <DialogDismiss>Cancel</DialogDismiss>
              <Button type="submit" $layer="brand" $kind="bevel">Save</Button>
            </Dialog>
          </DialogProvider>
        `}
      >
            ...
            <Dialog>
              ...
              <DialogProvider>
                ...
                <Dialog>
                  ...
                  <DialogDescription>…</DialogDescription>
                  <DialogDismiss>Cancel</DialogDismiss>
                  <DialogDismiss $layer="danger" $kind="bevel">Delete</DialogDismiss>
                </Dialog>
              </DialogProvider>
              <DialogDismiss $kind="bevel">Done</DialogDismiss>
            </Dialog>
