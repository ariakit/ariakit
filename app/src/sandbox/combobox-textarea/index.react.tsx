...
export default function Example() {
  ...
  return (
    <div className="flex flex-col gap-2 p-4">
      <label className="flex w-auto flex-col gap-2 p-0 indent-2">
        Comment
        <Ariakit.Combobox
          store={combobox}
          autoSelect
          ...
          className="h-auto w-[320px] p-2 sm:w-[380px]"
          render={
            <textarea
              ref={ref}
              rows={5}
      ...
      <Ariakit.ComboboxPopover
        ...
        className="max-h-[min(var(--popover-available-height,186px),186px)] min-w-[180px] max-w-[280px] rounded-md p-1"
      >
        {matches.map((value) => (
          <Ariakit.ComboboxItem
            ...
            className="scroll-m-1 py-1 [&>span]:truncate"
          >
            <span>{value}</span>
          </Ariakit.ComboboxItem>
        ))}
