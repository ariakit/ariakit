  ...
  return (
    <ExampleGrid>
      <Example
        ...
        code={`
          Install
          <Code>@ariakit/ui</Code>
          , then import
          <Code>Button</Code>
          and pass
          <Code>$kind="bevel"</Code>
          to it.
        `}
      >
        <p>
      ...
      <Example
        ...
        code={`
          Removed in v2:
          <Code $layer="danger">$kind="flat"</Code>
        `}
      >
        <p>
      ...
      <Example
        ...
        code={`
          Pass
          <Code $layer="transparent">$layer</Code>
          to keep only the ring.
        `}
      >
        <p>
      ...
      <Example
        ...
        code={`
          Set
          <Code $layer={false}>aria-expanded</Code>
          on the button.
        `}
      >
        <p>
      ...
      <Example
        ...
        code={`
          A chip with a
          <Code $edgeWeight="bold">bold</Code>
          ring.
        `}
      >
        <p>
      ...
      <Example
        ...
        code={`
          Import it from
          <Code $edge="brand" $edgeRaw>@ariakit/ui</Code>
          .
        `}
      >
        <p>
