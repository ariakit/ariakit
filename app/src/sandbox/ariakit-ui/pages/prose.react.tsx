...
// rather than a component, so each snippet still prints it, and the title keeps
// the snippets apart.
      ...
      */}
      ...
      >
        <Prose>
          ...
          <p>
            Read the{" "}
            <Link href="#prose" {...screenshotFocus}>
              styling guide
            </Link>{" "}
            for the details, or press <Kbd>⌘</Kbd> <Kbd>K</Kbd> to search the
            reference.
          </p>
          <HeadingLevel>
