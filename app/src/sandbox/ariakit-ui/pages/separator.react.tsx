      ...
      */}
      ...
      >
        <Prose>
          ...
          <Separator />
          {/*
            Heading takes its element from the surrounding context, so the level
            has to be visible in the snippet. This one resolves to an h4, which
            still has a size step of its own, so the dropped top margin shows.
          */}
          <HeadingLevel>
