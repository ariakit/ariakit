...
withCaptures(import.meta.dirname, async ({ query, test }) => {
  ...
  test(
    "page @visual",
    { annotation: { type: "ariviso:item", description: "ui/nav/page" } },
    async ({ page, visual }) => {
  ...
  test(
    "shows the hover cover on a row of a nested section @visual",
    {
      annotation: {
        type: "ariviso:item",
        description:
          "ui/nav/shows-the-hover-cover-on-a-row-of-a-nested-section",
      },
    },
    async ({ page, q, visual }) => {
  ...
  test(
    "moves the sidebar current cover on click and the focus ring with the keyboard @visual",
    {
      annotation: {
        type: "ariviso:item",
        description:
          "ui/nav/moves-the-sidebar-current-cover-on-click-and-the-focus-ring-with-the-keyboard",
      },
    },
    async ({ page, q, visual }) => {
      await forEachColorScheme(page, async (colorScheme) => {
