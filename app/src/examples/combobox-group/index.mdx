...
>
> If you're using `@ariakit/react-components`, you'll need to use the `Select` component instead.
>
> ```jsx {0-2} "label"0 'value="jp">J' "Continents"
> <ComboboxGroup label="Continents">
>   <ComboboxGroup label="Asia">
...
1. ### Install Dependencies
   ...
   Start by installing the required packages. You'll need `@ariakit/react` as the main dependency, and optionally `@ariakit/react-components` if you need lower-level access to the components.
