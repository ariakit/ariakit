...
export function getStackblitzFramework(
  ...
  // Generated projects can't install @ariakit/ui until the package publishes
  // (see the distribution TODO in app/src/lib/stackblitz.ts), so sources that
  // depend on it have no viable target instead of producing a project whose
  // install fails.
