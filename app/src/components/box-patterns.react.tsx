...
export function BoxPatternsRight() {
  ...
  const bottom = (
    <div className="absolute top-full end-0 mt-4 w-[220%] grid grid-cols-[1.2fr_1fr_1.4fr] gap-4 mask-l-from-50% mask-b-from-20%">
      <div className="ak-layer ak-layer-6 ak-frame-border h-40 ak-frame ak-frame-2xl/2 flex">
        <div className="ms-auto h-10 aspect-square ak-frame ak-frame-border ak-layer ak-layer-lighten-6" />
      </div>
      <div className="ak-layer ak-frame-border h-40 ak-frame ak-frame-2xl/2 flex flex-col gap-2">
        <div className="ak-layer ak-layer-6 ak-frame-border ak-frame ak-frame-p-1 h-10">
          <div className="h-full aspect-square ak-frame ak-frame-p-1 ring ak-layer ak-dark:ak-layer-darken-6" />
        </div>
        <div className="ak-layer ak-layer-6 ak-frame ak-frame-p-1 h-10" />
        <div className="ak-layer ak-layer-6 ak-frame ak-frame-p-1 h-10">
          <div className="h-full aspect-square ak-frame ak-frame-p-1 ring ak-layer ak-dark:ak-layer-darken-6" />
        </div>
      </div>
      <div className="ak-layer ak-layer-6 ak-frame-border h-40 ak-frame ak-frame-2xl/2 flex flex-col gap-2">
        ...
        <div className="ak-layer ak-layer-darken-6 ak-frame-border h-full ak-frame" />
      </div>
    </div>
  );

  const right = (
    <div className="absolute start-full flex flex-col gap-2 ms-4 -translate-y-[70%] ak-layer ak-layer-darken-6 ak-frame-border h-75 w-70 ak-frame ak-frame-2xl/2 mask-r-from-50% mask-t-from-50%">
  ...
  const left = (
    <div className="absolute end-full bottom-0 flex flex-col gap-1 me-4 ak-layer ak-layer-6 ak-frame-border h-40 w-[80%] ak-frame ak-frame-2xl/2 mask-l-from-50% mask-l-to-95% mask-t-from-50% mask-t-to-95% [--hole:var(--ak-layer-parent)]">
      <div className="flex-1" />
      <div className="flex">
        <div className="h-10 w-20 ak-frame ak-frame-p-1 ak-frame-border ak-layer ak-layer-6 ms-auto" />
      </div>
    </div>
  );
...
export function BoxPatternsLeftOnly() {
  ...
  const left = (
    <div className="absolute end-full me-4 flex gap-4">
      <div className="ak-layer ak-layer-darken-6 ak-frame-border w-80 ak-frame ak-frame-2xl/2 flex flex-col gap-2 -translate-y-28 mask-y-from-80% mask-y-to-95% mask-l-from-10% mask-l-to-40%">
        <div className="ak-layer ak-layer-6 ak-frame w-1/2 h-12 self-end" />
      ...
      <div className="flex flex-col gap-4 -translate-y-40">
        <div className="ak-layer ak-layer-darken-6 ak-frame ak-frame-2xl/2 h-20 ak-frame-border flex flex-col gap-2 mask-t-to-90%">
...
export function BoxPatternsRightOnly() {
  const top = (
    <div className="absolute bottom-full mb-4 w-full flex">
      <div className="ak-layer ak-frame-border w-48 h-32 absolute end-0 bottom-0 translate-x-22 ak-frame ak-frame-xl/1 gap-1 grid grid-rows-[1fr_--spacing(9)] mask-t-from-50% mask-t-to-90% mask-l-from-50% mask-l-to-90%">
        <div className="ak-frame ak-frame-p-1 justify-self-end flex-1 w-2/3">
          <div className="ak-layer ak-layer-6 ak-frame size-full" />
        </div>
        <div className="ak-layer ak-layer-darken-6 ak-frame ak-frame-border" />
      </div>
    </div>
  );
  ...
  const right = (
    <div className="absolute start-full ms-4 top-0 flex h-full gap-4">
      <div className="ak-layer ak-layer-6 ak-frame-border w-18 h-10 ak-frame ak-frame-xl/1 flex justify-end">
        <div className="ak-layer ak-layer-lighten-6 h-full w-1/2 ak-frame-border ak-frame" />
      </div>
      <div className="grid h-max mask-b-from-60% mask-t-from-70% -translate-y-35 gap-4">
        <div className="ak-layer ak-layer-6 ak-frame-border w-full h-10 ak-frame ak-frame-xl/1" />
        <div className="ak-layer ak-frame-border w-40 ak-frame ak-frame-xl/1 grid gap-1 h-max">
          <div className="ak-layer ak-layer-darken-6 h-9 ak-frame-border ak-frame ak-frame-p-1 flex justify-end">
            <div className="ak-layer ak-layer-6 h-full aspect-square ak-frame ak-frame-border" />
          </div>
          <div className="h-9 ak-frame ak-frame-p-1">
            <div className="ak-layer ak-layer-12 h-full aspect-square ak-frame" />
          </div>
          <div className="ak-layer h-9 ak-frame-border ak-frame ak-frame-p-1">
            <div className="ak-layer ak-layer-12 h-full aspect-square ak-frame" />
          </div>
          <div className="h-9 ak-frame ak-frame-p-1">
            <div className="ak-layer ak-layer-12 h-full aspect-square ak-frame" />
          </div>
          <div className="ak-layer ak-layer-6 ak-frame-border h-9 ak-frame self-end" />
        </div>
      </div>
      <div className="ak-layer ak-layer-lighten-6 ak-frame-border w-70 h-80 ak-frame ak-frame-3xl/2 flex flex-col gap-2 mask-r-from-70% mask-y-from-80% mask-y-to-95% mask-r-to-90% -translate-y-30">
        <div className="ak-layer ak-layer-darken-6 ak-frame-border ak-frame ak-frame-p-2 flex-1 grid grid-cols-3 gap-2">
          <div className="ak-layer ak-layer-6 ak-frame aspect-square" />
          <div className="ak-layer ak-layer-6 ak-frame aspect-square" />
          <div className="ak-layer ak-layer-6 ak-frame aspect-square" />
          <div className="ak-layer ak-layer-6 ak-frame aspect-square" />
          <div className="ak-layer ak-layer-6 ak-frame aspect-square" />
        ...
        <div className="ak-layer ak-layer-darken-6 ak-frame-border ak-frame h-14" />
      </div>
    </div>
  );
...
export function BoxPatternsMiddle() {
  ...
  const right = (
    <div className="absolute start-full ms-4 top-0 flex h-full gap-4">
      <div className="ak-layer ak-layer-6 ak-frame-border w-18 h-full ak-frame ak-frame-xl/1 flex justify-end">
        <div className="ak-layer ak-layer-lighten-6 h-full w-1/2 ak-frame-border ak-frame" />
      </div>
      <div className="grid h-max mask-b-from-60% mask-t-from-70% -translate-y-35 gap-4">
        <div className="ak-layer ak-layer-6 ak-frame-border w-full h-10 ak-frame ak-frame-xl/1" />
  ...
  const left = (
    <div className="absolute end-full me-4 flex gap-4">
      <div className="ak-layer ak-layer-darken-6 ak-frame-border w-80 ak-frame ak-frame-2xl/2 flex flex-col gap-2 -translate-y-28 mask-y-from-80% mask-y-to-95% mask-l-from-70% mask-l-to-95%">
        <div className="ak-layer ak-layer-6 ak-frame w-1/2 h-12 self-end" />
        <div className="ak-layer ak-layer-6 ak-frame w-3/4 h-12" />
        <div className="ak-layer ak-layer-6 ak-frame w-3/4 h-12 self-end" />
        <div className="ak-layer ak-layer-6 ak-frame w-1/3 h-12 self-end" />
...
export function BoxPatternsFull() {
  const top = (
    <div className="absolute bottom-full mb-4 w-[1000%] flex gap-4">
      <div className="ak-layer ak-layer-darken-6 ak-frame ak-frame-xl/1 w-1/6 ak-frame-border">
        <div className="flex flex-col gap-2 ak-frame ak-frame-cover ak-frame-p-2">
          <div className="ak-layer ak-layer-9 ak-frame h-12 w-4/5 self-end" />
          <div className="ak-layer ak-layer-9 ak-frame h-12 w-1/2 self-end" />
      ...
      <div className="ak-layer ak-layer-lighten-6 ak-light:ak-frame-border w-1/3 ak-frame ak-frame-2xl/2 grid content-end gap-(--ak-frame-padding)">
        <div className="ak-layer ak-layer-darken-6 ak-frame-border ak-frame h-10 w-full" />
        <div className="ak-layer ak-layer-darken-6 ak-frame-border ak-frame h-10 w-full" />
        <div className="ak-layer ak-layer-darken-6 ak-frame-border ak-frame h-10 w-full" />
        <div className="ak-layer ak-layer-6 ak-frame-border ak-frame h-8 w-1/5" />
      </div>
    </div>
  );
      ...
      <div className="flex flex-col gap-2 w-max">
        ...
        <div className="ak-frame ak-frame-2xl/2 ak-layer ak-frame-border w-64 grid grid-cols-2 gap-(--ak-frame-padding)">
          <div className="ak-layer ak-layer-6 ak-frame-border ak-frame ak-frame-p-1">
            <div className="ak-frame ak-layer ak-layer-6 size-6" />
          </div>
          <div className="ak-layer ak-layer-6 ak-frame ak-frame-p-1">
            <div className="ak-frame ak-layer ak-layer-6 size-6" />
          </div>
          <div className="ak-layer ak-layer-6 ak-frame ak-frame-p-1">
            <div className="ak-frame ak-layer ak-layer-6 size-6" />
  ...
  const bottom = (
    <div className="absolute top-full mt-4 end-0 w-[1000%] flex gap-4 justify-end">
      <div className="ak-layer ak-layer-darken-6 ak-frame-border w-1/3 ak-frame ak-frame-2xl/1 flex flex-col h-max divide-y">
        <div className="ak-layer ak-frame ak-frame-cover flex justify-end">
          <div className="ak-frame ak-layer ak-layer-6 size-6" />
        </div>
        <div className="ak-layer ak-frame ak-frame-cover flex justify-end">
          <div className="ak-frame ak-layer ak-layer-6 size-6" />
      ...
      <div className="ak-layer ak-frame-border ak-frame ak-frame-2xl/2">
        <div className="ak-layer ak-layer-darken-6 ak-frame ak-frame-cover ak-frame-border flex items-center gap-2">
          ...
          <div className="ak-layer ak-layer-12 ak-frame size-7 ms-auto" />
        </div>
        <div className="grid grid-cols-3 gap-(--ak-frame-padding) ak-frame ak-frame-cover">
          <div className="ak-layer ak-layer-6 ak-frame-border ak-frame ak-frame-p-1 aspect-square" />
          <div className="ak-layer ak-layer-6 ak-frame ak-frame-p-1 aspect-square" />
          <div className="ak-layer ak-layer-6 ak-frame ak-frame-p-1 aspect-square" />
          <div className="ak-layer ak-layer-6 ak-frame ak-frame-p-1 aspect-square" />
          <div className="ak-layer ak-layer-6 ak-frame ak-frame-p-1 aspect-square" />
          <div className="ak-layer ak-layer-6 ak-frame ak-frame-p-1 aspect-square" />
  ...
  const left = (
    <div className="absolute end-full me-4 flex gap-4 bottom-0">
      <div className="ak-layer ak-layer-darken-6 ak-frame-border w-80 ak-frame ak-frame-2xl/1.5 flex flex-col gap-(--ak-frame-padding)">
