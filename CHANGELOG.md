...
# [0.16.0](https://github.com/reakit/reakit/compare/reakit@0.15.13...reakit@0.16.0) (2019-02-05)
...
> You can use [reakit-codemods](https://github.com/reakit/reakit/tree/master/packages/reakit-codemods) to help you with the migration (thanks to [@PlayMa256](https://github.com/PlayMa256)).

* Reakit components don't return styled wrappers anymore, which means that you won't be able to use them directly as selectors. You can use [styled-selector](https://github.com/diegohaz/styled-selector) instead.

  ```diff
    import { styled, Group, Button } from "reakit";
  + import s from "styled-selector";

    const Comp = styled(Group)`
  -   ${Button} {
  +   ${s(Button)} {
        margin: 10px;
      }
