export default function Icon() {
  return (
    <svg viewBox="0 0 128 128" width={128} height={128}>
      ...
      <foreignObject width={128} height={128}>
        <div className="flex h-full flex-col items-end gap-1 p-2">
          <div className="h-4 w-12 gap-2 rounded border border-black/20 bg-white shadow-md dark:border-white/10 dark:bg-gray-500 dark:shadow-md-dark" />
          <div className="h-4 w-12 gap-2 rounded border border-black/20 bg-white shadow-md dark:border-white/10 dark:bg-gray-500 dark:shadow-md-dark" />
        </div>
      </foreignObject>
    </svg>
