      ...
      <foreignObject width={128} height={128}>
        <div className="h-full overflow-hidden">
          <div className="ml-6 mt-6 flex w-40 flex-col gap-2">
            <div className="flex h-40 w-full flex-col gap-1 rounded-lg border border-black/30 bg-gray-100 p-4 py-3 dark:border-white/30 dark:bg-gray-900">
              <div className="flex items-center gap-1">
                <div className="h-3 w-6 rounded-sm bg-black/55 dark:bg-white/60" />
