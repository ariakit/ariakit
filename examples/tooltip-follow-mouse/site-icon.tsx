    ...
    <svg viewBox="0 0 128 128" width={128} height={128}>
      <foreignObject width={128} height={128}>
        <div className="flex h-full flex-col items-center justify-center gap-4 p-5">
          <div className="h-2 w-8 bg-blue-600 dark:bg-blue-400" />
          <svg
            fill="#fff"
            height={13}
            width={13}
          ...
          <div className="-mt-3 ml-12 flex w-14 flex-col items-center gap-2 rounded bg-gray-450 p-2 pb-0 dark:bg-gray-300" />
        </div>
      </foreignObject>
    </svg>
  );
