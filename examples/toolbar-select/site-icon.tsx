  ...
  return (
    <svg viewBox="0 0 128 128" width={128} height={128}>
      <foreignObject width={128} height={128}>
        <div className="flex h-full flex-col items-center gap-2 overflow-hidden p-5">
          ...
          <div className="ml-14 w-24 rounded-lg border border-black/20 bg-white p-1.5 shadow dark:border-white/10 dark:bg-white/10 dark:shadow-dark">
            <div className="flex flex-col gap-1.5 overflow-hidden rounded">
              <div className="h-5 w-full rounded-sm bg-black/20 dark:bg-white/20" />
              <div className="h-5 w-full rounded-sm bg-blue-600" />
              <div className="h-5 w-full rounded-sm bg-black/20 dark:bg-white/20" />
            </div>
          </div>
        </div>
