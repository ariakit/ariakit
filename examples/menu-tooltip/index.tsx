    ...
    <MenuProvider>
      <TooltipProvider>
        <TooltipAnchor className="button" render={<MenuButton />}>
          <VisuallyHidden>Accessibility Shortcuts</VisuallyHidden>
          {icon}
        </TooltipAnchor>
        <Tooltip className="tooltip">Accessibility Shortcuts</Tooltip>
      </TooltipProvider>
      <Menu className="menu" gutter={4}>
        <MenuItem className="menu-item">VoiceOver</MenuItem>
        <MenuItem className="menu-item">Zoom</MenuItem>
        <MenuItem className="menu-item">Invert Colours</MenuItem>
        <MenuItem className="menu-item">Colour Filters</MenuItem>
        <MenuItem className="menu-item">Increase Contrast</MenuItem>
        <MenuItem className="menu-item">Reduce Transparency</MenuItem>
      </Menu>
    </MenuProvider>
  );
}
