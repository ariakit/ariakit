        ...
        <div className="pl-8 pt-4">
          <div className="flex flex-col items-center justify-center">
            <div className="flex flex-col gap-1.5">
              ...
              <div className="ml-[30px] mt-1 size-5 rounded-md bg-blue-600" />
              <div className="ml-4 flex w-32 flex-col gap-3 rounded-md border border-black/20 bg-white p-3 shadow dark:border-white/10 dark:bg-white/10 dark:shadow-dark">
                <div className="h-2.5 w-16 rounded-[1px] bg-black/40 dark:bg-white/50" />
                <div className="h-2.5 w-12 rounded-[1px] bg-blue-600 dark:bg-blue-500" />
                <div className="h-2.5 w-14 rounded-[1px] bg-black/40 dark:bg-white/50" />
              </div>
            </div>
          </div>
        </div>
