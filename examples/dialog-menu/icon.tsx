    ...
    <svg viewBox="0 0 128 128" width={128} height={128}>
      <foreignObject width={128} height={128}>
        <div className="flex h-full flex-col items-start justify-center p-5">
          ...
          <div className="-mt-2 ml-1 flex w-10 flex-col gap-1.5 rounded-sm border border-black/20 bg-white p-1.5 shadow dark:border-white/10 dark:bg-gray-550 dark:shadow-dark">
