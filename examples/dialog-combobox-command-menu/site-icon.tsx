        ...
        <div className="h-full overflow-hidden">
          <div className="mx-2 mt-7">
            <div className="flex w-full flex-col overflow-hidden rounded-lg border border-black/40 bg-white shadow-md dark:border-white/20 dark:bg-white/10 dark:shadow-md-dark">
              <div className="flex w-full items-center justify-between border-b border-inherit bg-white p-2 dark:bg-gray-900">
                <div className="flex items-center gap-1">
                  <div className="h-2 w-6 rounded-sm bg-black/50 dark:bg-white/60" />
              ...
              <div className="flex flex-col gap-1 p-1">
                ...
                <div className="flex h-4 w-full items-center rounded p-1">
                  <div className="h-2 w-1/2 rounded-sm bg-black/50 dark:bg-white/60" />
                </div>
                <div className="flex h-4 w-full items-center rounded p-1">
                  <div className="h-2 w-2/3 rounded-sm bg-black/50 dark:bg-white/60" />
                </div>
                <div className="flex h-4 w-full items-center rounded p-1">
                  <div className="h-2 w-1/3 rounded-sm bg-black/50 dark:bg-white/60" />
                </div>
              </div>
            </div>
          </div>
