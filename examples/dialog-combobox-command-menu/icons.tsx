    ...
    <svg viewBox="0 0 120 120" width={16} height={16}>
      <defs>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0" stopColor="#fe9d02" />
          <stop offset="1" stopColor="#f7701d" />
        </linearGradient>
      </defs>
      <path
        fill={`url(#${id})`}
...
export function CalculatorIcon() {
  ...
  return (
    <svg viewBox="0 0 120 120" width={16} height={16}>
      ...
      <path fill="#d4d4d2" d="M41 99a6 6 0 0 1 0-12h19a6 6 0 0 1 0 12Z" />
...
export function ContactsIcon() {
  ...
  return (
    <svg viewBox="0 0 120 120" width={16} height={16}>
      ...
      />
      <rect width="12.086" height="30" x="107.914" y="62.873" fill="#ff9500" />
      <rect width="12.086" height="30" x="107.914" y="32.873" fill="#5ac8fa" />
      <rect
        width="12.086"
        height="10"
        x="107.914"
    ...
    <svg viewBox="0 0 120 120" width={16} height={16}>
      <defs>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0" stopColor="#5bf776" />
          <stop offset="1" stopColor="#0dbc29" />
        </linearGradient>
      </defs>
      <rect fill={`url(#${id})`} width="120" height="120" rx="26" />
      <path
        fill="#fefefe"
    ...
    <svg viewBox="0 0 120 120" width={16} height={16}>
      <defs>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0" stopColor="#c873f5" />
