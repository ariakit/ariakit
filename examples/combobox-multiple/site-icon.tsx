      ...
      <foreignObject width={128} height={128}>
        <div className="h-full overflow-hidden">
          <div className="ml-6 mt-6 flex w-40 flex-col gap-2">
            <div className="flex h-8 w-full items-center gap-1 rounded-[5px] border border-black/30 bg-white px-3 py-2 dark:border-white/30 dark:bg-gray-900">
            ...
            <div className="flex w-full flex-col gap-3 rounded-[5px] border border-black/20 bg-white p-3 pl-2 shadow dark:border-white/10 dark:bg-white/10 dark:shadow-dark">
              ...
              <div className="flex w-full items-center gap-2">
                ...
                <div className="h-[10px] w-[60%] rounded-sm bg-black/45 dark:bg-white/50" />
              </div>
            </div>
          </div>
        </div>
